...
CartFullModel = rpart(formula = Annual_Sales ~ . , data = Mer_SalesTrainUncapped[,-1], method = "anova")  #method is annova because regression model is used. Class model is used for default setting
CartFullModel
